...
#define DELIM_CHARS "," //separetors for lists
struct mine_type* Mine_Type(char *uri,int len,struct worker_ct1 *wct1)
{
	DBGPRINT("==>Mine_Type\n");
	int i=0;
	...
	for(mine=&builtin_mime_type[i];mine->extension!=NULL;i++){
